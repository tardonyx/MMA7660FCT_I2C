/*******************************************************************************************************
     ...
     * Description:         Basic functions for the I2C communication with MMA7660FCT accelerometer
     * Created:             17 oct 2019
     * Author:              Andrey Bibea
...
/*
 * Writing data in MMA7660 register
 * @param   [in]    reg     -   addresss of MMA7660 register
...
/*
 * Reading data from MMA7660 register
 * @param   [in]    reg     -   addresss of MMA7660 register
 * @return          uint_8  -   data byte from register
 */
 ...
 * @param   [in]    params  -   sum of varios params you need from MODE struct
 * @return          None
 */
 ...
 * @param   [in]    params  -   sum of varios params you need from INTSU struct
 * @return          None
 */
 ...
 * @param           None
 * @return          None
 * @note            Write in registers you own parameters
 */
